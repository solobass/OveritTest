...
/* TEMPLATE NAME: Alumni Involvement */
...
<div class="text-block even contact-form"><div class="wrap cf">
<h4>Keep in touch!</h4>
<?php echo apply_filters('the_content', '[contact-form-7 id="328" title="Alumni Involvement"]'); ?>
</div></div>
