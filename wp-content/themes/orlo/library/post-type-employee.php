<?php
/* Bones Employee Type Example
This page walks you through creating 
a Employee type and taxonomies. You
...
// Flush rewrite rules for Employee types
...
// let's create the function for the Employee
function custom_post_employee() { 
	// creating (registering) the Employee 
	register_post_type( 'employee', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this Employee
		array( 'labels' => array(
			...
			'edit_item' => __( 'Edit Employees', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Employee', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Employee', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Employee', 'bonestheme' ), /* Search Employee Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the example Employee type', 'bonestheme' ), /* Employee Description */
			'public' => true,
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-icon.png', /* the icon for the Employee type menu */
